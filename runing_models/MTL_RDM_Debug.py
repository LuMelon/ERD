...
if torch.cuda.device_count() > 1:
    ...
    task_embedding = nn.DataParallel(task_embedding, device_ids=device_ids)
    senti_cls = nn.DataParallel(senti_cls, device_ids=device_ids)
    rdm_model = nn.DataParallel(rdm_model, device_ids=device_ids)
    rdm_classifier = nn.DataParallel(rdm_classifier, device_ids=device_ids)
